...
const tiers: Tier[] = [
  {
    ...
    features: [
      ...
      { text: 'Inline booking calendar', included: false },
      { text: 'Gallery page', included: false },
  ...
  },
  {
    ...
    features: [
      ...
      { text: 'Inline Calendly booking calendar', included: true },
      { text: 'Service area city pages (8 cities)', included: true },
      { text: 'Schema markup (LocalBusiness + Article)', included: true },
      { text: 'Photo gallery page', included: true },
      { text: 'ROI calculator on pricing page', included: true },
      { text: 'Online shop', included: false },
      { text: 'Expanded gallery (unlimited photos)', included: false },
  ...
  },
  {
    ...
    features: [
      ...
      { text: 'Online shop (Snipcart + gift cards)', included: true },
      { text: 'Expanded gallery (unlimited photos)', included: true },
...
const comparisonGroups: ComparisonGroup[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      { label: 'Inline Calendly booking calendar', starter: false, pro: true, premium: true },
  ...
  },
  {
    ...
    rows: [
      { label: 'Online shop (Snipcart)', starter: false, pro: false, premium: true },
      { label: 'Unlimited gallery photos', starter: false, pro: false, premium: true },
      { label: 'ROI calculator page', starter: false, pro: true, premium: true },
    ],
  },
  {
    category: 'Support',
