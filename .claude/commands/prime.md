...
#   Where2 Junk Removal Services LLC     → e.g. "The Enchanted Collective"
#   where2junk.com            → e.g. "enchantedmadison.com"
#   local residential & commercial junk removal service     → e.g. "luxury glamping and romantic experience property"
#   Manchester, NH          → e.g. "Madison, Indiana"
#   ASAP — April 2026     → e.g. "June 2026"
#   NH homeowners and small business operators needing fast, reliable junk removal  → e.g. "romantic couples aged 27–45 within 90 min drive"
#   junk removal, house/garage cleanout, yard waste removal, construction waste removal        → e.g. "glamping tents, cottage, day-use hot tub escapes, proposal packages"
#   drive online self-booking and own the Manchester NH junk removal market          → e.g. "drive direct bookings and own the romantic getaway category in southern Indiana"
#   Calendly (inline embed — react-calendly pattern)    → e.g. "Lodgify (launch) / OwnerRez (scale)"
#   LocalBusiness (HomeAndConstructionBusiness)       → e.g. "LodgingBusiness" or "LocalBusiness" or "ProfessionalService"

---

You are the orchestrator for the **Where2 Junk Removal Services LLC** (where2junk.com) website build.
...
| Variable | Source |
|----------|--------|
| Where2 Junk Removal Services LLC | initial-business-data.md Section 1 |
| where2junk.com | initial-business-data.md Section 1 |
| local residential & commercial junk removal service | initial-business-data.md Section 1 — one-phrase description |
| Manchester, NH | initial-business-data.md Section 1 |
| ASAP — April 2026 | initial-business-data.md Section 7 |
| NH homeowners and small business operators needing fast, reliable junk removal | initial-business-data.md Section 3 — specific, not generic |
| junk removal, house/garage cleanout, yard waste removal, construction waste removal | initial-business-data.md Section 2 |
| drive online self-booking and own the Manchester NH junk removal market | initial-business-data.md Section 5 |
| Calendly (inline embed — react-calendly pattern) | initial-business-data.md Section 5 — or "TBD — confirm before Phase 4" |
| LocalBusiness (HomeAndConstructionBusiness) | infer from business type — LocalBusiness / ProfessionalService / LodgingBusiness |
